...
use reth_metrics::{
    Metrics,
    metrics::{Counter, Gauge, Histogram, counter, gauge, histogram},
};
...
impl OpRBuilderMetrics {
    ...
    pub fn record_flashblock_indexed_metrics(
        ...
        let index_label = flashblock_index.to_string();
        histogram!(
            "op_rbuilder_flashblock_build_duration_by_index",
    ...
    pub fn record_flashblock_wait_for_next_tick(
        ...
        histogram!(
            "op_rbuilder_flashblock_wait_for_next_tick_duration",
